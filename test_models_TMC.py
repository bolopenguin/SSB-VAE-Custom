...
if opts.reseed > 0:
    for rep in range(opts.repetitions):
        ...
        #MODIFICA ESEGUITA
		#Vecchia versione: run_TMC(opts.model,opts.ps,opts.length_codes,opts.alpha,opts.gamma,opts.beta,opts.ofilename,opts.addvalidation,opts.reseed,new_seed,n_classes, labels, labels_total, labels_test, X_total, X_test, X_total_input, X_test_input, Y_total_input)
		#Sostituisci opts.gamma con opts.lambda_    
        run_TMC(opts.model,opts.ps,opts.length_codes,opts.alpha,opts.lambda_,opts.beta,opts.ofilename,opts.addvalidation,opts.reseed,new_seed,n_classes, labels, labels_total, labels_test, X_total, X_test, X_total_input, X_test_input, Y_total_input)
    ...
    for rep in range(opts.repetitions):
        #MODIFICA ESEGUITA
		#Vecchia versione: run_TMC(opts.model,opts.ps,opts.length_codes,opts.alpha,opts.gamma,opts.beta,opts.ofilename,opts.addvalidation,0,20,n_classes, labels, labels_total, labels_test, X_total, X_test, X_total_input, X_test_input, Y_total_input)
		#Sostituisci opts.gamma con opts.lambda_
        run_TMC(opts.model,opts.ps,opts.length_codes,opts.alpha,opts.lambda_,opts.beta,opts.ofilename,opts.addvalidation,0,20,n_classes, labels, labels_total, labels_test, X_total, X_test, X_total_input, X_test_input, Y_total_input)
