...
#MODIFICA ESEGUITA
#Vecchia versione: def run_20_news(model_id,percentage_supervision,nbits_for_hashing,alpha_val,gamma_val,beta_VAL,name_file,addval=1,reseed=0,seed_to_reseed=20): 
#Sostituisci gamma_val con lambda_val
def run_20_news(model_id,percentage_supervision,nbits_for_hashing,alpha_val,lambda_val,beta_VAL,name_file,addval=1,reseed=0,seed_to_reseed=20):
...
for rep in range(opts.repetitions):
	if opts.reseed > 0:
        ...
        #MODIFICA ESEGUITA
		#Vecchia versione: run_20_news(opts.model,percentage_supervision=ps,nbits_for_hashing=nbits,alpha_val=opts.alpha,gamma_val=opts.gamma,beta_VAL=opts.beta,name_file=opts.ofilename,addval=opts.addvalidation,reseed=opts.reseed,seed_to_reseed=new_seed)
		#Sostituisci  gamma_val con lambda_val e opts.gamma con opts.lambda_
		run_20_news(opts.model,percentage_supervision=ps,nbits_for_hashing=nbits,alpha_val=opts.alpha,lambda_val=opts.lambda_,beta_VAL=opts.beta,name_file=opts.ofilename,addval=opts.addvalidation,reseed=opts.reseed,seed_to_reseed=new_seed)
	else:
        #MODIFICA ESEGUITA
		#Vecchia versione: run_20_news(opts.model,percentage_supervision=ps,nbits_for_hashing=nbits,alpha_val=opts.alpha,gamma_val=opts.gamma,beta_VAL=opts.beta,name_file=opts.ofilename,addval=opts.addvalidation,reseed=opts.reseed,seed_to_reseed=20)
		#Sostituisci  gamma_val con lambda_val e opts.gamma con opts.lambda_
		run_20_news(opts.model,percentage_supervision=ps,nbits_for_hashing=nbits,alpha_val=opts.alpha,lambda_val=opts.lambda_,beta_VAL=opts.beta,name_file=opts.ofilename,addval=opts.addvalidation,reseed=opts.reseed,seed_to_reseed=20)
